...
def main():
    settings = Settings(
        endpoint="https://ai-patentforecast2-playground.services.ai.azure.com/",
        ...
        aad_token=DefaultAzureCredential(),
        # Insert the analyzer name.
        analyzer_id="key_words_extract",
        file_location="txt_files/descriptin_text.txt",
    )
